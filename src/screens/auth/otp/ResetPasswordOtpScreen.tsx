...
type Props = {
  route: RouteProp<RootStackParamList, 'ResetPasswordOtpScreen'>;
};
...
const ResetPasswordOtpScreen = ({ route }: Props) => {
      ...
      <View style={{ padding: 25 }}>
        <View style={{ height: '90%', marginTop: 5 }}>
          ...
          <View
            ...
            <TouchableOpacity onPressIn={() => navigation.navigate('ForgotPasswordScreen')}>
